...
class _JourneyPage extends StatelessWidget {
  const _JourneyPage();
  @override
  Widget build(BuildContext context) => const _ScaffoldStub(title: 'My Journey');
}

class _DailyPage extends StatelessWidget {
  const _DailyPage();
  @override
  Widget build(BuildContext context) => const _ScaffoldStub(title: 'Daily');
}

class _InsightPage extends StatelessWidget {
  const _InsightPage();
  @override
  Widget build(BuildContext context) => const _ScaffoldStub(title: 'Insight');
}

class _ReflectionPage extends StatelessWidget {
  const _ReflectionPage();
  @override
  Widget build(BuildContext context) => const _ScaffoldStub(title: 'Reflection');
}

class _MePage extends StatelessWidget {
  const _MePage();
  @override
  Widget build(BuildContext context) => const _ScaffoldStub(title: 'Me');
}
